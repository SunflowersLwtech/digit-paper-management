<template>
    <div class="header">
        ...
        <div class="logo">电子试卷管理</div>
        <div class="header-right">
            <div class="header-user-con">
                <el-dropdown class="user-name" trigger="click" @command="handleCommand">
                    <span class="el-dropdown-link">
                        <span v-if="userType=='01'">管理员：{{userInfo.username}}</span>
                        <span v-if="userType=='02'">教师：{{userInfo.realname==null?'暂无':userInfo.realname}}</span>
                         <span v-if="userType=='03'">学生：{{userInfo.realname==null?'暂无':userInfo.realname}}</span>
        ...
        <el-dialog
            ...
            <el-form ref="ruleForm" :model="eform" :rules="rules" label-width="120px">
                ...
                <el-form-item label="学号" prop="sno" v-if="userType=='03'">
                    <el-input v-model="eform.sno" placeholder="学号"></el-input>
                </el-form-item>
                <el-form-item label="班级" prop="cid" v-if="userType=='03'">
                    <el-select v-model="eform.cid" clearable placeholder="请选择">
