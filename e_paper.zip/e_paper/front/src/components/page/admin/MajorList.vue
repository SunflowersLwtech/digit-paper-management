  ...
  <div>
    <div class="container">
      <div class="handle-box">
         <el-input v-model="query.name" placeholder="请选择专业名称" class="handle-input mr10"></el-input>
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" >
        ...
        <el-table-column prop="remark" label="专业介绍" align="center"></el-table-column>
    ...
    <el-dialog :title="dialogName" :visible.sync="dialogVisible" width="35%">
        ...
        <el-form-item label="专业介绍" prop="remark">
            <el-input type="textarea" rows="5" v-model="form.remark" placeholder="专业介绍"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getData() {
        ...
        this.$axios.post('/api/major/selectPage',param).then(res => {
    ...
    handleAdd() {
        ...
        this.form = {};
        this.$refs['ruleForm'].clearValidate();
        this.dialogName = "专业新增";
    },
    // 保存操作，更新或新增调用
    save(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$axios.post(this.form.id?'/api/major/edit' : '/api/major/add', this.form).then(res => {
    ...
    handleDelete(index, row) {
        this.$confirm('确定要删除吗？', '提示', {
           type: 'warning'
             ...
             this.$axios.get('/api/major/deleteById?id='+row.id).then(res => {
