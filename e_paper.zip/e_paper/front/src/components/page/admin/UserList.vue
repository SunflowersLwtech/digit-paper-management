  ...
  <div>
    <div class="container">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" >
        ...
        <el-table-column prop="cname" label="班级" align="center">
            <template slot-scope="scope">
                <span v-if="scope.row.type == '01'">--</span>
                <span v-if="scope.row.type == '02'">{{scope.row.cname}}</span>
            </template>
        </el-table-column>
      <el-table-column prop="sno" label="学号" align="center">
          <template slot-scope="scope">
              <span v-if="scope.row.type == '01'">--</span>
              <span v-if="scope.row.type == '02'">{{scope.row.sno}}</span>
          </template>
      </el-table-column>
        ...
        <el-table-column prop="type" label="类型" align="center">
            <template slot-scope="scope">
                <el-button  type="success" size="mini" v-if="scope.row.type == '01'">教师</el-button>
                <el-button  type="warning" size="mini" v-if="scope.row.type == '02'">学生</el-button>
            </template>
        </el-table-column>
        ...
        <el-table-column prop="createTime" label="注册时间" align="center" width="160"></el-table-column>
    ...
    <el-dialog :title="dialogName" :visible.sync="dialogVisible" width="35%">
        ...
        <el-form-item label="班级" prop="cid" v-if="form.type=='02'">
            <el-select v-model="form.cid" clearable placeholder="请选择">
                <el-option v-for="item in classList" :key="item.id" :label="item.name" :value="item.id"></el-option>
            </el-select>
        </el-form-item>
        <el-form-item label="学号" prop="sno" v-if="form.type=='02'">
...
<script>
import { isMobile,isPsd } from '../../../utils/checkForm'
export default {
  name: "User",
  data() {
