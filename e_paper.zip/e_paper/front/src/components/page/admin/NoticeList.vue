  ...
  <div>
    <div class="container">
      <div class="handle-box">
         <el-input v-model="query.title" placeholder="请选择公告标题" class="handle-input mr10"></el-input>
         <el-button type="primary" icon="el-icon-search" @click="getData">查询</el-button>
         <el-button type="primary" icon="el-icon-plus" @click="handleAdd" v-if="type=='01'">添加</el-button>
      </div>
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" >
        <el-table-column type="selection" width="55" align="center"></el-table-column>
        <el-table-column prop="title" label="公告标题" align="center"></el-table-column>
        <el-table-column prop="status" label="状态" align="center" v-if="type=='01'">
            <template slot-scope="scope">
                <el-button  type="success" size="mini" v-if="scope.row.status == '01'">启用</el-button>
                <el-button  type="success" size="mini" v-if="scope.row.status == '02'">禁用</el-button>
            </template>
        </el-table-column>
        <el-table-column prop="createTime" label="创建时间" align="center"></el-table-column>
        <el-table-column label="操作" align="center" width="360">
          <template slot-scope="scope">
            <el-button type="info" icon="el-icon-view" size="mini" @click="handleRead(scope.$index, scope.row)">阅读</el-button>
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="handleEdit(scope.$index, scope.row)" v-if="type=='01'">编辑</el-button>
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleDelete(scope.$index, scope.row)" v-if="type=='01'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!-- 添加阅读弹出框 -->
    <el-dialog title="公告内容" :visible.sync="readDialogVisible" width="55%">
...
export default {
  ...
  methods: {
    ...
    getData() {
        ...
        this.$axios.post('/api/notice/selectPage',param).then(res => {
    ...
    handleAdd() {
        ...
        this.form = {};
        this.$refs['ruleForm'].clearValidate();
        this.dialogName = "公告新增";
    },
    // 保存操作，更新或新增调用
    save(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$axios.post(this.form.id?'/api/notice/edit' : '/api/notice/add', this.form).then(res => {
    ...
    handleDelete(index, row) {
        this.$confirm('确定要删除吗？', '提示', {
           type: 'warning'
             ...
             this.$axios.get('/api/notice/deleteById?id='+row.id).then(res => {
